...
if __name__ == '__main__':
    ...
    val_set = dataset_bad[int(0.7*len(dataset_bad)):int(0.8*len(dataset_bad))] + dataset_good[int(0.7*len(dataset_good)):int(0.8*len(dataset_good))]
    ...
    clf_1 = MLPClassifier(5,activation='relu',learning_rate_init=0.001, max_iter=500, random_state=0)
    clf_2 = MLPClassifier(10,activation='relu',learning_rate_init=0.001, max_iter=500, random_state=0)
    clf_3 = MLPClassifier(100,activation='relu',learning_rate_init=0.001, max_iter=500, random_state=0)
